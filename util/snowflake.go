...
func NewWorker(machineID, serviceID int64) *SnowflakeWorker {
...
func getSnowflakeWorker() *SnowflakeWorker {
	snowflakeOnce.Do(func() {
		snowflakeWorker = NewWorker(0, 0)
	})
	return snowflakeWorker
}

func GetSnowflakeID() int64 {
	return getSnowflakeWorker().getID()
}
